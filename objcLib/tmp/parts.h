...
// EQUIVALENT OF:
// template <class Node> class parts_Ring2
// ----------------------------------------------------------
...
// ----------------------------------------------------------
#ifndef ZZ_parts_RING2_INCLUDED
#define ZZ_parts_RING2_INCLUDED
...
// ----------------------------------------------------------
class parts_Ring2Element {
public:
    Participant *next;
    Participant *prev;
    parts_Ring2Element(){ next=prev=NULL; }
};
...
public:
    ...
    parts_Ring2Iterator(){tail=nxt=NULL; dir=0;}
    ...
    Participant* const operator--();
    parts_Ring2Iterator(Participant *p){start(p);}
};
    
#endif // ZZ_parts_RING2_INCLUDED
