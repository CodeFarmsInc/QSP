...
// EQUIVALENT OF:
// template <class Holder,class Element> class byName_Array
// --------------------------------------------------------------------
// Implementation note:
...
#ifndef ZZ_byName_ARRAY_INCLUDED
#define ZZ_byName_ARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class byName_ArrayHolder {
public:
    unsigned int sz; // present size
    int num,incr; // higest valid index,increment
    void** array;
    byName_ArrayHolder(){ sz=0; num= -1; incr=0; array=NULL;}
};
...
#endif // ZZ_byName_ARRAY_INCLUDED
