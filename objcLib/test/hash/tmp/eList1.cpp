...
Employee* eList_LinkedList1::tail(Company *p){return p->ZZds.ZZeList.tail;}

Employee* eList_LinkedList1::head(Company *p){
...
void eList_LinkedList1::addHead(Company *p, Employee *c){
    p->ZZds.ZZeList.tail=eList_Ring1::addHead(p->ZZds.ZZeList.tail,c);
}

void eList_LinkedList1::addTail(Company *p, Employee *c){
    p->ZZds.ZZeList.tail=eList_Ring1::addTail(p->ZZds.ZZeList.tail,c);
}

void eList_LinkedList1::append(Company *p,Employee *c1, Employee *c2){
    p->ZZds.ZZeList.tail=eList_Ring1::append(p->ZZds.ZZeList.tail,c1,c2);
}

void eList_LinkedList1::remove(Company *p, Employee *c){
    p->ZZds.ZZeList.tail=eList_Ring1::remove(p->ZZds.ZZeList.tail,c);
}

Employee* const eList_LinkedList1::next(Company *p,Employee *c){
...
void eList_LinkedList1::sort(ZZsortFun cmpFun, Company *p){
...
// ---------------------------------------------------------------
void eList_LinkedList1::merge(Employee *s,Employee *t,Company *p){
...
Employee* eList_LinkedList1::child(Company *p){
    Employee* t;
...
// ------------------------------------------------------------------
void eList_LinkedList1::setTail(Company* p,Employee* c,int check){
    Employee *pp,*tail;
...
void eList_LinkedList1Iterator::start(const Company *p){
    eList_Ring1Iterator::start(p->ZZds.ZZeList.tail); 
}

Employee* eList_LinkedList1Iterator::fromHead(Company *p){
