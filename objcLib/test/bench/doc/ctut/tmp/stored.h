...
// EQUIVALENT OF:
// template <class Node> class stored_Ring2
// ----------------------------------------------------------
...
// ----------------------------------------------------------
#ifndef ZZ_stored_RING2_INCLUDED
#define ZZ_stored_RING2_INCLUDED
...
// ----------------------------------------------------------
class stored_Ring2Element {
public:
    PartType *next;
    PartType *prev;
    stored_Ring2Element(){ next=prev=NULL; }
};
...
public:
    ...
    stored_Ring2Iterator(){tail=nxt=NULL; dir=0;}
    ...
    virtual PartType* const operator--();
    stored_Ring2Iterator(PartType *p){start(p);}
};
    
#endif // ZZ_stored_RING2_INCLUDED
