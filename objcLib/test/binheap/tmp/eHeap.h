...
// EQUIVALENT OF:
// template <class Holder,class Element> class eHeap_Array
// --------------------------------------------------------------------
// Implementation note:
...
#ifndef ZZ_eHeap_ARRAY_INCLUDED
#define ZZ_eHeap_ARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class eHeap_ArrayHolder {
public:
    unsigned int sz; // present size
    int num,incr; // higest valid index,increment
    Employee* array;
    eHeap_ArrayHolder(){ sz=0; num= -1; incr=0; array=NULL;}
};
