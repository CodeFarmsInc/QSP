...
// EQUIVALENT OF:
// template <class Holder,class Element> class pHeap_Array
// --------------------------------------------------------------------
// Implementation note:
...
#ifndef ZZ_pHeap_ARRAY_INCLUDED
#define ZZ_pHeap_ARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class pHeap_ArrayHolder {
public:
    unsigned int sz; // present size
    int num,incr; // higest valid index,increment
    Employee** array;
    pHeap_ArrayHolder(){ sz=0; num= -1; incr=0; array=NULL;}
};
