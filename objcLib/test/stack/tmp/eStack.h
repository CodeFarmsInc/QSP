...
// EQUIVALENT OF:
// template <class Holder,class Element> class eStack_Array
// --------------------------------------------------------------------
// Implementation note:
...
#ifndef ZZ_eStack_ARRAY_INCLUDED
#define ZZ_eStack_ARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class eStack_ArrayHolder {
public:
    unsigned int sz; // present size
    int num,incr; // higest valid index,increment
    Employee* array;
    eStack_ArrayHolder(){ sz=0; num= -1; incr=0; array=NULL;}
};
...
protected:
    ...
    static Employee* indHeap(Header *hp,int i,bck callback); // like ind() but callback
    ...
    static int binSearch(cmpType cmpF,Header *hp,Employee *op,int *found);
public:
...
#endif // ZZ_eStack_ARRAY_INCLUDED
