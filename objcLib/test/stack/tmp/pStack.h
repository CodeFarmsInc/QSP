...
// EQUIVALENT OF:
// template <class Holder,class Element> class pStack_Array
// --------------------------------------------------------------------
// Implementation note:
...
#ifndef ZZ_pStack_ARRAY_INCLUDED
#define ZZ_pStack_ARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class pStack_ArrayHolder {
public:
    unsigned int sz; // present size
    int num,incr; // higest valid index,increment
    Employee** array;
    pStack_ArrayHolder(){ sz=0; num= -1; incr=0; array=NULL;}
};
...
#endif // ZZ_pStack_ARRAY_INCLUDED
