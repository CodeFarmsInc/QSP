...
// EQUIVALENT OF:
// template <class Holder,class Element> class pArr_Array
// --------------------------------------------------------------------
// Implementation note:
...
#ifndef ZZ_pArr_ARRAY_INCLUDED
#define ZZ_pArr_ARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class pArr_ArrayHolder {
public:
    unsigned int sz; // present size
    int num,incr; // higest valid index,increment
    Employee** array;
    pArr_ArrayHolder(){ sz=0; num= -1; incr=0; array=NULL;}
};
