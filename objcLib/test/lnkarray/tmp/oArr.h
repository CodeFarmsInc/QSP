...
// EQUIVALENT OF:
// template <class Holder,class Element> class oArr_Array
// --------------------------------------------------------------------
// Implementation note:
...
#ifndef ZZ_oArr_ARRAY_INCLUDED
#define ZZ_oArr_ARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class oArr_ArrayHolder {
public:
    unsigned int sz; // present size
    int num,incr; // higest valid index,increment
    Employee* array;
    oArr_ArrayHolder(){ sz=0; num= -1; incr=0; array=NULL;}
};
