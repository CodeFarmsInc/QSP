...
void printRings(char *label,A *tail1,A *tail2){
    A *ap;
    ...
    cout << "ring1:\n";
    for(ap=itRing1.fromTail(tail1); ap; ap=itRing1.next()){ ap->prt(); }
    cout << "\n";
...
int main(void){
    int i;
    A *ap,*ap12,*tail1,*tail2,*tailx; A* arr[10];
    ...
    ap12=new A(12);
    tail1=ring1::append(tail1,arr[9],ap12);
    tail2=ring2::append(tail2,arr[9],ap12);
        
    printRings("first data",tail1,tail2);

    tail1=ring1::sort(A::cmpA,tail1);
    tail2=ring2::sort(A::cmpA,tail2);

    
    printRings("after sorting",tail1,tail2);
    ...
    printRings("after splitting",tail1,tail2);

    ring1::merge(tail1,tailx);
    ap=new A(13);
    ring1::insert(ap,arr[2]);
    ap=new A(14);
    ring1::insert(ap,ap12);

    printRings("after merging and insert",tail1,tail2);
    return(0);
}
