...
// EQUIVALENT OF:
// template <class Node> class ring1_Ring2
// ----------------------------------------------------------
...
// ----------------------------------------------------------
#ifndef ZZ_ring1_RING2_INCLUDED
#define ZZ_ring1_RING2_INCLUDED
...
// ----------------------------------------------------------
class ring1_Ring2Element {
public:
    A *next;
    A *prev;
    ring1_Ring2Element(){ next=prev=NULL; }
};
...
public:
    ...
    ring1_Ring2Iterator(){tail=nxt=NULL; dir=0;}
    A* fromHead(A *p);
    ...
    A* const operator++();
    A* const operator--();
    ring1_Ring2Iterator(A *p){start(p);}
};
    
#endif // ZZ_ring1_RING2_INCLUDED
