...
// EQUIVALENT OF:
// template <class Node> class ring2_Ring1
// ----------------------------------------------------------
#ifndef ZZ_ring2_RING1_INCLUDED
#define ZZ_ring2_RING1_INCLUDED
...
// ----------------------------------------------------------
class ring2_Ring1Element {
public:
    A *next;
    ring2_Ring1Element(){ next=NULL; }
};
...
public:
    ...
    void start(A *p);
    A* const operator++();
    ring2_Ring1Iterator(A *p){start(p);}
};
    
#endif // ZZ_ring2_RING1_INCLUDED
